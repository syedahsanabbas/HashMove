...
public class TestCase_UserCreation_003 extends BaseClass {
...

	{
		...
		// Enter User ID
		lp.setuserid(getCellData(3, 1, "TestData1"));
		logger.info("User ID = " + cell.getStringCellValue() + " has entered");

		// Enter Password
		lp.setpassword(getCellData(3, 2, "TestData1"));
