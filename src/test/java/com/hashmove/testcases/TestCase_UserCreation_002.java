...
public class TestCase_UserCreation_002 extends BaseClass {
	...
	@Epic("EPUC002")
	@Feature("Feature: Add new user with role = Admin on ELM Portal")
...

	{
		...
		// Open Hash Move URL
				...
				// Enter User ID
				lp.setuserid(getCellData(2, 1, "UserCreationTestData"));
				logger.info("User ID = " + cell.getStringCellValue() + " has entered");

				// Enter Password
				lp.setpassword(getCellData(2, 2, "UserCreationTestData"));
				...
				// Enter First Name
				alp.setfirstname(getCellData(2, 3, "UserCreationTestData"));
				logger.info("First Name = " + cell.getStringCellValue() + " has entered");
				Thread.sleep(1000);

				// Enter Last Name
				alp.setlastname(getCellData(2, 4, "UserCreationTestData"));
				logger.info("Last Name = " + cell.getStringCellValue() + " has entered");
				Thread.sleep(1000);

				// Enter City
				alp.setcity(getCellData(2, 5, "UserCreationTestData"));
				logger.info("City = " + cell.getStringCellValue() + " has entered");
				Thread.sleep(2000);

				// Enter Contact
				alp.setcontact(getCellData(2, 6, "UserCreationTestData"));
				logger.info("Contact = " + cell.getStringCellValue() + " has entered");
				Thread.sleep(1000);

				// Enter Email
				alp.setemail("test" + alp.getSaltString() + "@" + getCellData(2, 7, "UserCreationTestData"));
				logger.info("Email = " + cell.getStringCellValue() + " has entered");
				Thread.sleep(1000);

				// Select User Role
				alp.setuserrole(getCellData(2, 8, "UserCreationTestData"));
				logger.info("User Role = " + cell.getStringCellValue() + " has entered");
				Thread.sleep(1000);

				// Select Business Unit
				alp.clickbusinessunitdropdown();
				alp.setbusinessunit(getCellData(2, 9, "UserCreationTestData"));
				Thread.sleep(1000);
