...
public class TC_QA_FCLSpotRateandBooking_001 extends BaseClass {
	...
	{
		System.out.println("***************TC_QA_FCLSpotRateandBooking_001*******************");
		...
		// Enter User ID
		clp.setuserid(getCellData(1, 1, "QAFCLCustomerTestData"));
		logger.info("User ID = " + cell.getStringCellValue() + " has entered");

		// Enter Password
		clp.setpassword(getCellData(1, 2, "QAFCLCustomerTestData"));
		...
		hp.setcargoreadinessmonthyear(getFormulaMonthYearDateAsString(1, 4, "QAFCLCustomerTestData"));
		hp.setcargoreadinessday(getFormulaDayDateAsString(1, 5, "QAFCLCustomerTestData"));
		
		// Select Cargo Type
		hp.clickcargotypedropdown();
		Thread.sleep(1000);
		hp.setcargotype(getCellData(1, 6, "QAFCLCustomerTestData"));
		logger.info("Cargo Type = " + cell.getStringCellValue() + " has selected");
		Thread.sleep(1000);

		// Enter HS Code
		hp.sethscode(getCellData(1, 7, "QAFCLCustomerTestData"));
		logger.info("HS Code = " + cell.getStringCellValue() + " has entered");
		Thread.sleep(2000);

		// Enter Cargo Description
		hp.setcargodescription(getCellData(1, 8, "QAFCLCustomerTestData"));
		...
		Thread.sleep(2000);
		hp.setpickuplocation(getCellData(1, 9, "QAFCLCustomerTestData"));
		logger.info("Pickup Location = " + cell.getStringCellValue() + " has entered");
		Thread.sleep(2000);

		// Enter Port of Pickup
		hp.setportofpickup(getCellData(1, 10, "QAFCLCustomerTestData"));
		...
		hp.setdeliverylocation(getCellData(1, 11, "QAFCLCustomerTestData"));
		logger.info("Delivery Location = " + cell.getStringCellValue() + " has entered");
		Thread.sleep(2000);

		// Enter Port of Delivery
		hp.setportofdelivery(getCellData(1, 12, "QAFCLCustomerTestData"));
		...
		Thread.sleep(2000);
		hp.setcontainersize(getCellData(1, 13, "QAFCLCustomerTestData"));
		logger.info("Container Size = " + cell.getStringCellValue() + " has selected");

		// Enter Quantity
		hp.setquantity(getCellData(1, 14, "QAFCLCustomerTestData"));
		logger.info("Quantity = " + cell.getStringCellValue() + " has entered");
		Thread.sleep(2000);

		// Enter Weight
		hp.setweight(getCellData(1, 15, "QAFCLCustomerTestData"));
		...
		String paymentterms = getCellData(1, 16, "QAFCLCustomerTestData");
		...
		if (paymentterms.equals("Advance Payment at the time of Booking Confirmation")) {
			...
			hp.setpaymenttermsdays(getCellData(1, 17, "QAFCLCustomerTestData"));
			Thread.sleep(2000);
			hp.clicksavepaymentterms();
			Thread.sleep(2000);
		...
		// Enter User ID
		plp.setuserid(getCellData(1, 1, "QAFCLProviderTestData"));
		logger.info("User ID = " + cell.getStringCellValue() + " has entered");

		// Enter Password
		plp.setpassword(getCellData(1, 2, "QAFCLProviderTestData"));
		logger.info("Password = " + cell.getStringCellValue() + " has entered");
		...
		// Enter Shipping Line
		rrp.setshipingline(getCellData(1, 3, "QAFCLProviderTestData"));
		...
		rrp.setratevaliditystartmonthyear(getFormulaMonthYearDateAsString(1, 9, "QAFCLProviderTestData"));
		rrp.setratevaliditystartday(getFormulaDayDateAsString(1, 10, "QAFCLProviderTestData"));

		Thread.sleep(2000);

		// Enter Rate Validity End Date
		rrp.clickratevalidityend();
		rrp.setratevalidityendmonthyear(getFormulaMonthYearDateAsString(1, 11, "QAFCLProviderTestData"));
		rrp.setratevalidityendday(getFormulaDayDateAsString(1, 12, "QAFCLProviderTestData"));

		// Select Customer Payment Terms

		String customerpaymentterms = getCellData(1, 13, "QAFCLProviderTestData");
		...
		// Open Hash Move Customer Portal URL
		driver.get(qacustomerportalurl);
		logger.info("Hash Move Customer Portal has opened!!!");
		Thread.sleep(10000);
		...
		bpp.setreferencenumber(getCellData(1, 18, "QAFCLCustomerTestData"));
		logger.info("Reference Number = " + cell.getStringCellValue() + " has entered");

		// Enter Shipping Instructions
		bpp.setshippinginstructions(getCellData(1, 19, "QAFCLCustomerTestData"));
		...
		// Select SHIPPER NAME
		bdp.setshippername(getCellData(1, 20, "QAFCLCustomerTestData"));
		...
		bdp.setmainconsigneename(getCellData(1, 26, "QAFCLCustomerTestData"));
		...
		// Click Booking Link
		bdp.clickbookings();
		logger.info("Click Booking link has clicked!!!");
		Thread.sleep(10000);
		...
		// Click Upload button
		bdp.clickupload2();
		logger.info("Booking Confirmation Document (CRO/BC/SC) Document has uploaded successfully!!!");
		Thread.sleep(5000);
		...
		bdp.setshipmentdetails(getCellData(1, 14, "QAFCLProviderTestData"));
		...
		bdp.setdeparturedatemonthyear(getFormulaMonthYearDateAsString(1, 15, "QAFCLProviderTestData"));
		bdp.setdeparturedateday(getFormulaDayDateAsString(1, 16, "QAFCLProviderTestData"));

		// Set Arrival Date
		bdp.clickarrivalto();
		bdp.setarrivaldatemonthyear(getFormulaMonthYearDateAsString(1, 17, "QAFCLProviderTestData"));
		bdp.setarrivaldateday(getFormulaDayDateAsString(1, 18, "QAFCLProviderTestData"));
		Thread.sleep(2000);

		// Enter Vessel Name
		bdp.setvesselname(getCellData(1, 19, "QAFCLProviderTestData"));
		logger.info("Vessel Name = " + cell.getStringCellValue() + " has entered");
		Thread.sleep(2000);

		// Enter Voyage Number
		bdp.setvoyagenumber(getCellData(1, 20, "QAFCLProviderTestData"));
		...
		// Enter Bill Number
		bdp.setbillnumber(getCellData(1, 22, "QAFCLProviderTestData"));
		logger.info("Bill Number = " + cell.getStringCellValue() + " has entered");
		Thread.sleep(2000);

		// Set BL Date
		bdp.clickbldate();
		bdp.setbldatemonthyear(getFormulaMonthYearDateAsString(1, 23, "QAFCLProviderTestData"));
		bdp.setbldateday(getFormulaDayDateAsString(1, 24, "QAFCLProviderTestData"));
		...
		// Click Upload button
		bdp.clickupload3();
		logger.info("BL Document has uploaded successfully!!!");
		Thread.sleep(2000);
		...
		bdp.setshipmentdetailsintransit(getCellData(1, 25, "QAFCLProviderTestData"));
		...
		bdp.setshipmentstatus(getCellData(1, 26, "QAFCLProviderTestData"));
