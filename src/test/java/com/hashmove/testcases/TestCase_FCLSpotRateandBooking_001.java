...
public class TestCase_FCLSpotRateandBooking_001 extends BaseClass {
...

	{
		...
		// Enter User ID
		clp.setuserid(getCellData(1, 1, "QACustomerTestData"));
		logger.info("User ID = " + cell.getStringCellValue() + " has entered");

		// Enter Password
		clp.setpassword(getCellData(1, 2, "QACustomerTestData"));
		...
		String searchcategory = getCellData(1, 3, "QACustomerTestData");
		...
		Thread.sleep(2000);
		hp.setpickuplocation(getCellData(1, 9, "QACustomerTestData"));
		logger.info("Pickup Location = " + cell.getStringCellValue() + " has entered");
		Thread.sleep(2000);

		// Enter Port of Pickup
		hp.setportofpickup(getCellData(1, 10, "QACustomerTestData"));
		 ...
		 *  hp.setdeliverylocation(getCellData(1, 9, "QACustomerTestData")); 
		...
		hp.setportofdelivery(getCellData(1, 12, "QACustomerTestData"));
		...
		Thread.sleep(2000);
		hp.setcontainersize(getCellData(1, 13, "QACustomerTestData"));
		logger.info("Container Size = " + cell.getStringCellValue() + " has selected");

		// Enter Quantity
		hp.setquantity(getCellData(1, 14, "QACustomerTestData"));
		logger.info("Quantity = " + cell.getStringCellValue() + " has entered");
		Thread.sleep(2000);

		// Enter Weight
		hp.setweight(getCellData(1, 15, "QACustomerTestData"));
		...
		String paymentterms = getCellData(1, 16, "QACustomerTestData");
		...
		if (paymentterms.equals("Advance Payment at the time of Booking Confirmation")) {
			...
			hp.setpaymenttermsdays(getCellData(1, 17, "QACustomerTestData"));
			Thread.sleep(2000);
			hp.clicksavepaymentterms();
			Thread.sleep(2000);
		...
		// Enter User ID
		plp.setuserid(getCellData(1, 1, "QAProviderTestData"));
		logger.info("User ID = " + cell.getStringCellValue() + " has entered");

		// Enter Password
		plp.setpassword(getCellData(1, 2, "QAProviderTestData"));
		logger.info("Password = " + cell.getStringCellValue() + " has entered");
		...
		// Enter Shipping Line
		rrp.setshipingline(getCellData(1, 3, "QAProviderTestData"));
		...
		String customerpaymentterms = getCellData(1, 9, "QAProviderTestData");
		...
		bpp.setreferencenumber(getCellData(1, 18, "QACustomerTestData"));
		logger.info("Reference Number = " + cell.getStringCellValue() + " has entered");

		// Enter Shipping Instructions
		bpp.setshippinginstructions(getCellData(1, 19, "QACustomerTestData"));
		...
		bdp.setshipmentdetails(getCellData(1, 10, "QACustomerTestData"));
