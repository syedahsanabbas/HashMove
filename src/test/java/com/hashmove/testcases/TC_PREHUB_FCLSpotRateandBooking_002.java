...
public class TC_PREHUB_FCLSpotRateandBooking_002 extends BaseClass {
	...
	{
		System.out.println("***************TC_PREHUB_FCLSpotRateandBooking_002*******************");
		...
		// Enter Password
		clp.setpassword(getCellData(2, 2, "PreHubFCLCustomerTestData"));
		...
		String searchcategory = getCellData(2, 3, "PreHubFCLCustomerTestData");
		...
		hp.setcargoreadinessmonthyear(getFormulaMonthYearDateAsString(2, 4, "PreHubFCLCustomerTestData"));
		hp.setcargoreadinessday(getFormulaDayDateAsString(2, 5, "PreHubFCLCustomerTestData"));
		Thread.sleep(1000);

		// Select Cargo Type
		hp.clickcargotypedropdown();
		Thread.sleep(1000);
		hp.setcargotype(getCellData(2, 6, "PreHubFCLCustomerTestData"));
		logger.info("Cargo Type = " + cell.getStringCellValue() + " has selected");
		Thread.sleep(1000);

		// Enter HS Code
		hp.sethscode(getCellData(2, 7, "PreHubFCLCustomerTestData"));
		logger.info("HS Code = " + cell.getStringCellValue() + " has entered");
		Thread.sleep(2000);

		// Enter Cargo Description
		hp.setcargodescription(getCellData(2, 8, "PreHubFCLCustomerTestData"));
		...
		Thread.sleep(2000);
		hp.setpickuplocation(getCellData(2, 9, "PreHubFCLCustomerTestData"));
		logger.info("Pickup Location = " + cell.getStringCellValue() + " has entered");
		Thread.sleep(2000);

		// Enter Port of Pickup
		hp.setportofpickup(getCellData(2, 10, "PreHubFCLCustomerTestData"));
		...
		hp.setportofdelivery(getCellData(2, 12, "PreHubFCLCustomerTestData"));
		...
		Thread.sleep(2000);
		hp.setcontainersize(getCellData(2, 13, "PreHubFCLCustomerTestData"));
		logger.info("Container Size = " + cell.getStringCellValue() + " has selected");

		// Enter Quantity
		hp.setquantity(getCellData(2, 14, "PreHubFCLCustomerTestData"));
		...
		// Enter User ID
		plp.setuserid(getCellData(2, 1, "PreHubFCLProviderTestData"));
		logger.info("User ID = " + cell.getStringCellValue() + " has entered");

		// Enter Password
		plp.setpassword(getCellData(2, 2, "PreHubFCLProviderTestData"));
		logger.info("Password = " + cell.getStringCellValue() + " has entered");
		...
		// Enter Shipping Line
		rrp.setshipingline(getCellData(2, 3, "PreHubFCLProviderTestData"));
		...
		rrp.setratepercontainer(getCellData(2, 4, "PreHubFCLProviderTestData"));
		logger.info("Rate Per Container = " + cell.getStringCellValue() + " has entered");

		// Enter Bill of Lading
		rrp.setbillofloading(getCellData(2, 5, "PreHubFCLProviderTestData"));
		logger.info("Bill of Lading = " + cell.getStringCellValue() + " has entered");

		// Enter LOLO
		rrp.setlolo(getCellData(2, 6, "PreHubFCLProviderTestData"));
		logger.info("LOLO = " + cell.getStringCellValue() + " has entered");

		// Enter SEAL Charges
		rrp.setsealcharges(getCellData(2, 7, "PreHubFCLProviderTestData"));
		...
		rrp.setratevaliditystartmonthyear(getFormulaMonthYearDateAsString(2, 9, "PreHubFCLProviderTestData"));
		rrp.setratevaliditystartday(getFormulaDayDateAsString(2, 10, "PreHubFCLProviderTestData"));

		Thread.sleep(2000);

		// Enter Rate Validity End Date
		rrp.clickratevalidityend();
		rrp.setratevalidityendmonthyear(getFormulaMonthYearDateAsString(2, 11, "PreHubFCLProviderTestData"));
		rrp.setratevalidityendday(getFormulaDayDateAsString(2, 12, "PreHubFCLProviderTestData"));

		// Select Customer Payment Terms

		String customerpaymentterms = getCellData(2, 13, "PreHubFCLProviderTestData");
		...
		bpp.setreferencenumber(getCellData(2, 18, "PreHubFCLCustomerTestData"));
		logger.info("Reference Number = " + cell.getStringCellValue() + " has entered");

		// Enter Shipping Instructions
		bpp.setshippinginstructions(getCellData(2, 19, "PreHubFCLCustomerTestData"));
		...
		bdp.setshipmentdetails(getCellData(2, 10, "PreHubFCLProviderTestData"));
		...
		bdp.setdeparturedatemonthyear(getFormulaMonthYearDateAsString(2, 11, "PreHubFCLProviderTestData"));
		bdp.setdeparturedateday(getFormulaDayDateAsString(2, 12, "PreHubFCLProviderTestData"));
