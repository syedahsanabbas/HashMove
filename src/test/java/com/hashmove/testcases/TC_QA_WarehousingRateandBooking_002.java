...
//						********* TC_QA_WarehousingRateandBooking_002 *********
//		Description: Verify that DFF Customer should request and Book the Warehouse when pallet Type = European

public class TC_QA_WarehousingRateandBooking_002 extends BaseClass {

	@Test(priority = 0)
	@Description("Verify that DFF Customer should request and Book the Warehouse when pallet Type = European")
	@Severity(SeverityLevel.CRITICAL)
	@Epic("EPWH-002")
	@Feature("Feature: Verify that DFF Customer should request and Book the Warehouse when pallet Type = European")
	@Story("Story: Warehouse Searching and Booking")
	public void verifywarehouserateandbooking() throws Exception

	{
		System.out.println("***************TC_QA_WarehousingRateandBooking_002*******************");
		...
		// Select Storage Type
		String storagetype = getCellData(2, 10, "QAWarehouseing");
		...
		// Select Pallet Type
		String pallettype = getCellData(2, 12, "QAWarehouseing");
		...
		if (pallettype.equals("STANDARD SIZE")) {
			...
			Thread.sleep(2000);
			// Quantity has entered
			dcp.setquantityeuropean(getCellData(2, 13, "QAWarehouseing"));
			logger.info("Quantity " + cell.getStringCellValue() + " has entered");
			// Enter Weight
			...
			Thread.sleep(2000);
			// Quantity has entered
			dcp.setquantitychep(getCellData(2, 13, "QAWarehouseing"));
			logger.info("Quantity " + cell.getStringCellValue() + " has entered");
			// Enter Weight
			dcp.setweightperpalletchep(getCellData(2, 14, "QAWarehouseing"));
			logger.info("Weight " + cell.getStringCellValue() + " has entered");
			Thread.sleep(2000);
			dcp.clickaddchep();
		...
		dcp.setcurrency(getCellData(2, 15, "QAWarehouseing"));
		...
		String customclearance = getCellData(2, 16, "QAWarehouseing");
		...
		if (customclearance.equals("Yes")) {
			...
			String expectedport = getCellData(2, 17, "QAWarehouseing");
			...
			bpp.setcontainersize(getCellData(2, 18, "QAWarehouseing"));
			logger.info("Container Size: " + cell.getStringCellValue() + " has selected");

			// Enter Quantity
			bpp.setcontainerquantity(getCellData(2, 19, "QAWarehouseing"));
			logger.info("Quantity : " + cell.getStringCellValue() + " has entered");
		...
		String insuranceservices = getCellData(2, 20, "QAWarehouseing");
		...
		if (insuranceservices.equals("Yes")) {
			...
			bpp.setvalueofgoods(getCellData(2, 21, "QAWarehouseing"));
		...
		String expectedwarehousecharges = getCellData(2, 22, "QAWarehouseing");
		...
		String expectedcustomclearancerate = getCellData(2, 23, "QAWarehouseing");
		...
		String expectedinsurancepremium = getCellData(2, 24, "QAWarehouseing");
		...
		String expectedgrosstotal = getCellData(2, 25, "QAWarehouseing");
		...
		String expectedvat = getCellData(2, 26, "QAWarehouseing");
		...
		String expectednettotal = getCellData(2, 27, "QAWarehouseing");
		...
		String expectedtotalpayable = getCellData(2, 28, "QAWarehouseing");
		...
		// Add Assertion on Warehouse Charges
		String expectedwarehousechargesonviewsummary = getCellData(2, 22, "QAWarehouseing");
		...
		// Add Assertion on NET TOTAL
		String expectednettotalonviewsummary = getCellData(2, 27, "QAWarehouseing");
		...
		bdp.setreferencenumber(getCellData(2, 29, "QAWarehouseing"));
		...
		// Enter YOUR SKU CODE
		String yourskucode = bdp.setyourskucode(getCellData(2, 34, "QAWarehouseing") + bdp.getSaltString());
		logger.info("YOUR SKU CODE = " + yourskucode + " has entered");

		// Enter SKU DESCRIPTION
		String yourskudescription = bdp.setskudescription(getCellData(2, 35, "QAWarehouseing") + bdp.getSaltString());
		logger.info("SKU DESCRIPTION = " + yourskudescription + " has entered");
		Thread.sleep(1000);

		// Enter HS Code
		bdp.sethscode(getCellData(2, 36, "QAWarehouseing"));
		...
		Thread.sleep(2000);
		bdp.setpackagetype(getCellData(2, 41, "QAWarehouseing"));
		logger.info("PACKAGE TYPE ( WHAT'S ON PALLET? ) = " + cell.getStringCellValue() + " has selected");

		// Enter UOM / PACKAGE
		bdp.setuomperpackage(getCellData(2, 42, "QAWarehouseing"));
		...
		String expectedtotaluomqty = getCellData(2, 47, "QAWarehouseing");
		...
		String addbatchnumber = getCellData(2, 48, "QAWarehouseing");
		...
		if (addbatchnumber.equals("Yes")) {
			...
			// Enter BATCH NUMBER
			String batchnumber = bdp.setbatchnumber(getCellData(2, 49, "QAWarehouseing") + bdp.getSaltString());
			logger.info("BATCH NUMBER = " + batchnumber + " has entered");

			// Select PRODUCTION DATE
			bdp.clickproductiondate();
			Thread.sleep(2000);
			bdp.setproductionmonthyear(getFormulaMonthYearDateAsString(2, 50, "QAWarehouseing"));
			bdp.setproductionday(getFormulaDayDateAsString(2, 51, "QAWarehouseing"));
			Thread.sleep(1000);

			// Select EXPIRY DATE
			bdp.clickexpirydate();
			Thread.sleep(2000);
			bdp.setexpirymonthyear(getFormulaMonthYearDateAsString(2, 52, "QAWarehouseing"));
			bdp.setexpiryday(getFormulaDayDateAsString(2, 53, "QAWarehouseing"));
			Thread.sleep(1000);
		...
		String expectedtotalamountinskudetailsgrid = getCellData(2, 54, "QAWarehouseing");
		...
		bdp.selectservice(getCellData(2, 55, "QAWarehouseing"));
		Thread.sleep(3000);

		// Add Assertion on EMPTY WOODEN PALLETS VALUE EXCLUDING VAT
		String expectedemptywoodenpalletsvalueexcludingvat = getCellData(2, 56, "QAWarehouseing");
		String actualemptywoodenpalletsvalueexcludingvat = bdp
				.getemptywoodenpalletsvalueexcludingvat(getCellData(2, 55, "QAWarehouseing"));
		System.out.println(
		...
		String expectedrecevingbypalletsvalueexcludingvat = getCellData(2, 58, "QAWarehouseing");
		String actualrecevingbypalletsvalueexcludingvat = bdp
				.getemptywoodenpalletsvalueexcludingvat(getCellData(2, 57, "QAWarehouseing"));
		System.out.println(
		...
		String expectednettotaloninboundshipment = getCellData(2, 59, "QAWarehouseing");
		...
		// Enter Reference Number
		bdp.setreferencenumber2(getCellData(2, 60, "QAWarehouseing"));
		logger.info("Reference Number = " + cell.getStringCellValue() + " has entered");
		Thread.sleep(1000);
		...
		Thread.sleep(2000);
		bdp.settruckcategory2(getCellData(2, 61, "QAWarehouseing"));
		logger.info("Truck Category = " + cell.getStringCellValue() + " has selected");

		// Select Truck Type
		bdp.clicktrucktypedropdown2();
		Thread.sleep(2000);
		bdp.settrucktype2(getCellData(2, 62, "QAWarehouseing"));
		logger.info("Truck Type = " + cell.getStringCellValue() + " has selected");

		// Enter Truck Reg Number
		bdp.settruckregnumber2(getCellData(2, 63, "QAWarehouseing"));
		logger.info("Truck Reg Number = " + cell.getStringCellValue() + " has entered");
		Thread.sleep(1000);
		...
		// Enter Pin Address
		bdp.setpinaddress(getCellData(2, 64, "QAWarehouseing"));
		...
		bdp.setmaindeliveryaddress(getCellData(2, 64, "QAWarehouseing"));
		logger.info("Main Delivery Address = " + cell.getStringCellValue() + " has entered");
		Thread.sleep(2000);

		// Enter Remarks
		bdp.setremarks2(getCellData(2, 65, "QAWarehouseing"));
		logger.info("Remarks = " + cell.getStringCellValue() + " has entered");
		Thread.sleep(1000);
		...
		String By = getCellData(2, 66, "QAWarehouseing");
		...
		if (By.equals("By Pallet")) {
			...
			// Enter TOTAL PALLET QTY
			bdp.settotalpalletqty2(getCellData(2, 67, "QAWarehouseing"));
			logger.info("TOTAL PALLET QTY = " + cell.getStringCellValue() + " has entered");
			Thread.sleep(1000);
			...
			bdp.settotalpackageqty(getCellData(2, 68, "QAWarehouseing"));
		...
		// Add Assertion on TOTAL AMOUNT in SKU Details grid
		String expectedtotalamountinskudetailsgrid2 = getCellData(2, 70, "QAWarehouseing");
		...
		bdp.selectservice(getCellData(2, 71, "QAWarehouseing"));
		Thread.sleep(3000);

		// Add Assertion on EMPTY WOODEN PALLETS VALUE EXCLUDING VAT
		String expectedemptywoodenpalletsvalueexcludingvat2 = getCellData(2, 72, "QAWarehouseing");
		String actualemptywoodenpalletsvalueexcludingvat2 = bdp
				.getemptywoodenpalletsvalueexcludingvat2(getCellData(2, 71, "QAWarehouseing"));
		System.out.println(
		...
		String expecteddispatchingbypalletvalueexcludingvat = getCellData(2, 74, "QAWarehouseing");
		String actualdispatchingbypalletvalueexcludingvat = bdp
				.getdispatchingbypalletvalueexcludingvat(getCellData(2, 73, "QAWarehouseing"));
		System.out.println(
		...
		String expectednettotalonoutboundshipment = getCellData(2, 75, "QAWarehouseing");
